...
# Feature Extraction
CUDA_VISIBLE_DEVICES=0,1 python extract_features_fp.py --data_h5_dir DIR_TO_COORDS --data_slide_dir DATA_DIRECTORY --csv_path CSV_FILE_ROOT --feat_dir FEATURES_DIRECTORY --batch_size 512 --slide_ext .svs
```
